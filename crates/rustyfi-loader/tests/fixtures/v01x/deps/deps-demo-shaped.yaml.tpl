# SYNTHESIZED — not real upstream bytes. `rustyfi-deps.yaml` is never
# committed upstream (gitignored everywhere, saphe-split `demo/.gitignore:3`,
# `lib-rustyfi/packages/.gitignore:4`), so this fixture is "honest
...
# resolves to an absolute `rustyfi-envelope.yaml` path under the package
...
- name: registered.6f2b80e9bb7c4e8af2104999fc25dbb3.math.0.0.1
  path: "{{ROOT}}/store/math.0.0.1/rustyfi-envelope.yaml"
  dependencies:
  - name: registered.6f2b80e9bb7c4e8af2104999fc25dbb3.stdlib.0.0.1
    used_as: Stdlib
  test_only: false
- name: registered.6f2b80e9bb7c4e8af2104999fc25dbb3.tabular.0.0.1
  path: "{{ROOT}}/store/tabular.0.0.1/rustyfi-envelope.yaml"
  dependencies:
  - name: registered.6f2b80e9bb7c4e8af2104999fc25dbb3.stdlib.0.0.1
    used_as: Stdlib
  test_only: false
