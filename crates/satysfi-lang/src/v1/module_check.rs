...
fn process_link_member(
    ...
    let outer_rigid_raw = typecheck::lower_type_expr(&outer_ty, &rigid_map, SatysfiVersion::V0_1);
    ...
    let scheme_raw = typecheck::lower_type_expr(&outer_ty, &scheme_map, SatysfiVersion::V0_1);
