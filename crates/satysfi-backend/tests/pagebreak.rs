...
//! backend function, mirroring `crates/satysfi-lang/tests/page_prims.rs`'s
...
use satysfi_backend::{chop_page, Length, PlacedLine, PureHorzBox, VertBox};
...
fn place_block_at_does_not_extract_footnotes() {
    ...
    let lines = satysfi_backend::place_block_at((Length::ZERO, Length::ZERO), block);
