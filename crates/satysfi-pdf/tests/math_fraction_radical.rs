...
use satysfi_pdf::{render_pdf, render_pdf_ttf, Base14Metrics, TtfFontStore};
...
fn as_math_parts(bx: PureHorzBox) -> (Length, Length, Length, Vec<satysfi_backend::MathGlyph>, Vec<GraphicsElem>) {
    match bx {
        PureHorzBox::Math {
            width,
            height,
