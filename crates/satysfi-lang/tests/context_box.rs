...
fn setting_dominant_wide_script_leaves_the_rest_of_the_context_equal() {
    ...
    assert_eq!(updated.dominant_wide_script, satysfi_backend::Script::Kana);
    let expected = satysfi_backend::Context { dominant_wide_script: updated.dominant_wide_script, ..base };
