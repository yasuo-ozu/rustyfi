...
/// file will be READ rather than on what the document says. So it is four
/// flags (`--svg-outline-math`, `--svg-math`, `--katex`, `--unicode-math`)
...
/// `∑ₐᵇ` where `\sum_a^b` is available, and either SVG mode would put a
