...
//! `crates/satysfi-lang/tests/record_types.rs` already proves for the
...
use satysfi_lang::{elaborate, eval, primitives, typecheck, v1::lower, CompileError};
...
fn eval_v01(lib_src: &str, doc_src: &str) -> Result<Value, String> {
    ...
    typecheck::typecheck_with_version(&elaborated, SatysfiVersion::V0_1).map_err(|e| format!("typecheck: {e}"))?;
